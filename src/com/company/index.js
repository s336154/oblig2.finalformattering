...
function info() {
    ...
    if (filmF === "velg film her") {
        ...
        document.getElementById("antallX").innerHTML = "må skrive inn riktig antall";
        ErrorX = true;
    } else if (fornavnF === "") {
        ...
        document.getElementById("telefonnrX").innerHTML = "må skrive inn riktig telefon nummeret";
        ErrorX = true;
    } else if (epostF === "") {
